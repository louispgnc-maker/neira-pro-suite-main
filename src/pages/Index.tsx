    ...
    <div className="min-h-screen flex flex-col bg-white">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs sm:text-sm text-gray-500">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="hidden sm:inline">Données hébergées en France</span>
                <span className="sm:hidden">Hébergé en France</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                <CheckCircle2 className="h-4 w-4 sm:h-5 sm:w-5 text-purple-600 flex-shrink-0" />
            ...
            <div>
              ...
              <div className="space-y-2 sm:space-y-4">
                ...
                <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-5 bg-red-50 rounded-xl border border-red-100 hover:shadow-md transition-shadow">
                  <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-sm sm:text-base text-gray-700"><strong>Documents éparpillés</strong> difficiles à retrouver et à partager</p>
                </div>
                <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-5 bg-red-50 rounded-xl border border-red-100 hover:shadow-md transition-shadow">
                  <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 sm:p-10 rounded-2xl border-2 border-blue-200 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Jusqu'à -70% de temps administratif</h3>
              <p className="text-sm sm:text-base text-gray-600 sm:text-lg">Concentrez-vous sur votre cœur de métier en automatisant les tâches répétitives</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 sm:p-10 rounded-2xl border-2 border-purple-200 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Jusqu'à +45% de productivité</h3>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 sm:p-10 rounded-2xl border-2 border-purple-200 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Sécurité renforcée & confidentialité</h3>
              <p className="text-sm sm:text-base text-gray-600 sm:text-lg">Chiffrement & accès contrôlés pour garantir la protection de vos données</p>
            </div>

            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 sm:p-10 rounded-2xl border-2 border-blue-200 hover:shadow-lg transition-shadow">
              <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-blue-600 mb-3 sm:mb-4">24/7</div>
              <h3 className="text-lg sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Suivi en temps réel 24/7</h3>
              <p className="text-sm sm:text-base text-gray-600 sm:text-lg">Suivez en temps réel l'avancement de vos dossiers</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-gray-400 py-8 sm:py-12 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto text-center">
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">© 2026 Neira - Tous droits réservés</p>
