...
const planConfigs = {
  ...
  'professionnel': {
    ...
    features: [
      ...
      { title: '35 signatures / mois', description: 'Plus de signatures' },
  ...
  'cabinet-plus': {
    ...
    icon: Building2,
    color: 'orange',
    limits: 'Stockage illimité • Dossiers illimités • Clients illimités • 70 signatures/mois/utilisateur',
    features: [
      ...
      { title: '70 signatures / mois / utilisateur', description: 'Généreux quota' },
