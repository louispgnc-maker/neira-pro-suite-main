                    ...
                    {documents.map(d => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className={`p-2 rounded ${role === 'notaire' ? 'bg-orange-100' : 'bg-blue-100'}`}>
                            <svg className={`h-5 w-5 ${role === 'notaire' ? 'text-orange-600' : 'text-blue-600'}`} fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="flex items-center gap-2">
                          <Button 
                            size="icon" 
                            variant="ghost"
                            className={role === 'notaire' ? 'hover:bg-orange-50' : 'hover:bg-blue-50'}
