...
const statusColorsAvocat: Record<string, string> = {
  ...
  "Brouillon": "bg-muted text-gray-900 border-border",
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      let query = supabase
        ...
        .eq("owner_id", user.id)
        .eq("role", role)
        .order("updated_at", { ascending: false }); // Plus récent en haut
      if (debounced) {
      ...
      <div className="p-6">
        <div className="flex flex-col gap-4 mb-6 md:flex-row md:items-center md:justify-between">
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-600 mt-1">Gérez tous vos documents juridiques</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="flex items-center justify-center h-[400px] border border-dashed border-border rounded-lg">
            <div className="text-center">
              <p className="text-gray-900">Aucun document pour le moment</p>
