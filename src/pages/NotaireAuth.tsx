...
export default function NotaireAuth() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-16 px-6 bg-gradient-to-br from-orange-50 via-orange-100 to-amber-50 overflow-hidden min-h-screen flex flex-col">
      ...
      <Card className="w-full border border-gray-200 shadow-xl">
        ...
        <CardContent>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <Button 
              variant="outline" 
              className="w-full border-orange-600 text-orange-600 hover:bg-orange-50 hover:text-orange-600 mb-3"
