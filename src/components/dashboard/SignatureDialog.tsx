        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 border rounded-lg p-4 bg-gray-50">
            <div className="flex items-center justify-between">
              <Label className="text-base font-semibold">Position de la signature sur le document</Label>
              <span className="text-xs text-gray-500">Où le client signera</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="signature-x" className="text-sm">Position X (horizontal)</Label>
                <Input
                  id="signature-x"
                  type="number"
                  min="0"
              ...
              <div className="space-y-2">
                <Label htmlFor="signature-y" className="text-sm">Position Y (vertical)</Label>
                <Input
                  id="signature-y"
                  type="number"
                  min="0"
            ...
            <p className="text-xs text-gray-600">
              💡 <strong>Format A4:</strong> 595 points de large, 842 points de haut. Le client signera exactement à cet emplacement.
            </p>
          </div>
