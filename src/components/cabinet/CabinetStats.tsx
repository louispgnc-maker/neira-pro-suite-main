  ...
  const loadAllStats = async () => {
    ...
    try {
      ...
      for (const member of members) {
        ...
        // Compter les DOSSIERS de l'ESPACE PERSONNEL de ce membre
        ...
        // Compter les CLIENTS de l'ESPACE PERSONNEL de ce membre
        ...
        // Compter les DOCUMENTS de l'ESPACE PERSONNEL de ce membre
