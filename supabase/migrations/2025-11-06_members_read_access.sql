-- Migration: Allow active members to read members list
-- Date: 2025-11-06

-- Replace get_cabinet_members to allow owner OR any active member of the cabinet to read
...
begin
  ...
  -- Active members of the cabinet can read
  if exists (
